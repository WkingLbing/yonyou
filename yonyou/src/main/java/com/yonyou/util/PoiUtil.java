...
public class PoiUtil {
    ...
    {        
		...
		public static List getDataFromExcel(String filePath) throws Exception {
            ...
            FileInputStream fis =new FileInputStream(filePath);  //获取一个绝对地址的流
            Workbook wookbook =  new HSSFWorkbook(fis);//得到工作簿//2003版本的excel，用.xls结尾
            ...
            for(int i = 1 ; i <= totalRowNum ; i++)
            {
                ...
                String latitude =cell.getStringCellValue();
